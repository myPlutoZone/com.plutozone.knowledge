...
- [학습 목표-2] 1) **면접 시 자세와 의지** 및 **포트폴리오** 그리고 **팀프로젝트 산출물** 2) 참여 기업 솔루션 3) 정보처리기사
...
- [Programming] Java, JSP, Spring MVC/Boot, Python for Machine Learning + Deep Learning, Android
...
- 팀 구성과 팀장 그리고 평가
	- 원하는 팀원: 열심히 할 수 있는
	- 분쟁 해결 방안: 토론과 협의 그리고 담판, 다수결, 양보, 강사
	- 희망 분야: 설계, 백앤드, 프론트
	- 희망 역할: 팀장, 부팀장, 조력자, 팀원
	- 희망 팀원과 팀장:
	- 참여도: 100% ~ 50%
...
- Software Architect(SA, 소프트웨어 아키텍트)의 분류
	- AA(Application Architect: 개발 표준, 프레임워크 등 `어플리케이션 설계자`)
	- TA(Technical Architect: OS, WAS, DB 설치 등 `하드웨어와 서버 및 네트워크 기술 담당자`)
